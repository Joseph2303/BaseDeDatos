          ...
          <div class="card-body">
            <form action="edit2.php?idJustificacionAusencia=<?php echo $_GET['idJustificacionAusencia']; ?>" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input name="justificacion" type="text" class="form-control" value="<?php echo $justificacion; ?>" placeholder="Justificación">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                    <input name="NombreEncargado" type="text" class="form-control" value="<?php echo $NombreEncargado; ?>" placeholder="Nombre del Encargado" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 col-form-label custom-label">Descripción</label>
                    <div class="col-md-8">
                    <input name="descripcion" type="text" class="form-control" value="<?php echo $descripcion; ?>" placeholder="Descripción" readonly>
                    </div>
                </div>
                <div class="form-group row">
