        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input name="documento" type="file" class="form-control" value="<?php echo $documento; ?>">
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input name="revision" type="text" class="form-control" value="<?php echo $revision; ?>" readonly>
              </div>
            </div>
            <div class="form-group row">
