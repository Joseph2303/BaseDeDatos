          ...
          <div class="card-body">
            <form method="POST" action="">
              <div class="form-group row">
                <label for="idUsuario" class="col-md-4 col-form-label custom-label">Usuario</label>
                <div class="col-md-8">
                  <input type="text" name="idUsuario" class="form-control" placeholder="Digite la descripcion del usuario">
                </div>
              </div>
