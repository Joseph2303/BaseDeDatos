...
<body style="background-image: url(img/fondo-degradado-tonos-verdes_23-2148387744.avif);  background-repeat:  no-repeat;  background-size: cover ;">
  <div class="container p-4">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">Buscar horario </div>
          <div class="card-body">
            <form method="POST" action="">
              <div class="form-group row">
                <label for="idEmpleado" class="col-md-4 col-form-label custom-label">Horario</label>
                <div class="col-md-8">
                  <input type="text" name="idEmpleado" class="form-control" placeholder="Digite la descripcion del horario">
                </div>
              </div>
